...
{   
	...
	p.setup = function() 
    {
        ...
        var timeData = new setDataOnGraph(p,"BLOCKGAMETIME",0,1);
        var tabData = new setDataOnGraph(p,"BLOCKGAMETAB",1,1);
        ...
        p.createResolutionInfo("Dots Collected:",x,y * 3);
        p.createResolutionInfo(tabData,x,y * 3 + 20);
        
            p.createResolutionInfo("Maximum Dots Collected:",x + 20,y * 4);
